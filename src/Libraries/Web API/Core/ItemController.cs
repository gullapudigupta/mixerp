                ...
                Columns = new List<EntityColumn>()
                                {
                                        ...
                                        new EntityColumn { ColumnName = "item_sold_points",  PropertyName = "ItemSoldPoints",  DataType = "int",  DbDataType = "int",  IsNullable = false,  IsPrimaryKey = false,  IsSerial = false,  Value = "0",  MaxLength = 0 },
